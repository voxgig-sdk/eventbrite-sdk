...
func registerSDKWords(r *eng.Registry, client *sdk.EventbriteSDK) {
...
func runOp(client *sdk.EventbriteSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
