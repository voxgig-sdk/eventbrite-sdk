...
describe("EventEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set EVENTBRITE_TEST_EVENT_ENTID JSON to run live")
      return
    end
...
function event_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("EVENTBRITE_TEST_EVENT_ENTID")
  ...
  if env["EVENTBRITE_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["EVENTBRITE_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
