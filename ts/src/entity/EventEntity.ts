...
import type {
  ...
  EventListMatch,
  EventCreateData,
} from '../EventbriteTypes'

// TODO: needs Entity superclass
class EventEntity extends EventbriteEntityBase<Event> {
  ...
  async create(this: any, reqdata?: EventCreateData, ctrl?: Control): Promise<EventEntity> {
