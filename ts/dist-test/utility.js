...
function envOverride(m) {
    if ('TRUE' === process.env.EVENTBRITE_TEST_LIVE ||
        'TRUE' === process.env.EVENTBRITE_TEST_OVERRIDE) {
    ...
    m.EVENTBRITE_TEST_EXPLAIN = process.env.EVENTBRITE_TEST_EXPLAIN || m.EVENTBRITE_TEST_EXPLAIN;
    return m;
}
