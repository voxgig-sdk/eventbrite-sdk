...
(0, node_test_1.describe)('EventDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('EVENTBRITE_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EventbriteSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        const client = new __1.EventbriteSDK({
            apikey: env.EVENTBRITE_APIKEY,
        });
        let idmap = env['EVENTBRITE_TEST_EVENT_ENTID'];
