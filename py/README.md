...
The Python SDK for the Eventbrite API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/eventbrite-sdk/releases)) or
...
```
py/
├── eventbrite_sdk.py         -- Main SDK module
...
The main module (`eventbrite_sdk`) exports the SDK class.
