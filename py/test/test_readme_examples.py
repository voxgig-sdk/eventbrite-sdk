# Eventbrite SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EventbriteSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EventbriteSDK(...) and EventbriteSDK.test(...) become
#      EventbriteSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "eventbrite_sdk"
_SDK_CLASS = "EventbriteSDK"
