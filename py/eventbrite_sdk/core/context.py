...
from eventbrite_sdk.core.control import EventbriteControl
...
from eventbrite_sdk.core.helpers import get_ctx_prop, to_map
...
class EventbriteContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, EventbriteSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EventbriteResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EventbriteResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return EventbriteError(code, msg, self)
