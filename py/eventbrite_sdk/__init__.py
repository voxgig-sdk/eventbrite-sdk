...
from eventbrite_sdk.utility import register

# Load features
from eventbrite_sdk.feature.base_feature import EventbriteBaseFeature
from eventbrite_sdk.features import _has_feature, _make_feature
...
class EventbriteSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EventbriteUtility()
        self._utility = utility

        from eventbrite_sdk.config import shared_config
    ...
    def get_utility(self):
        return EventbriteUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EventbriteSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Event(self, data=None) -> "EventEntity":
        ...
        from eventbrite_sdk.entity.event_entity import EventEntity
        return EventEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "EventbriteSDK":
        if sdkopts is None:
            sdkopts = {}
