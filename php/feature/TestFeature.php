...
// Eventbrite SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class EventbriteTestFeature extends EventbriteBaseFeature
{
    ...
    public function init(EventbriteContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (EventbriteContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = EventbriteParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (EventbriteContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(EventbriteContext $ctx, $op, $args): array
    {
