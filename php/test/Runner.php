...
class EventbriteTestRunner
{
    ...
    {
        $live = self::getenv('EVENTBRITE_TEST_LIVE');
        $override = self::getenv('EVENTBRITE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('EVENTBRITE_TEST_EXPLAIN');
...
class_alias('EventbriteTestRunner', 'Runner');
class_alias('EventbriteHelpers', 'Helpers');
