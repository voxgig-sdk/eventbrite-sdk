...
// Eventbrite SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EventbriteSDK::test)
...
{
    private const SDK_CLASS = 'EventbriteSDK';
    ...
    private const SDK_BASE = 'eventbrite_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../eventbrite_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
