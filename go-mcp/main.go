// Command Eventbrite-mcp is an MCP server exposing the Eventbrite
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Eventbrite_list  — list records of an entity
//	Eventbrite_load  — load a single record of an entity
//
