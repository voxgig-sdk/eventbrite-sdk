...
type Args struct {
	Entity string         `json:"entity" jsonschema:"event"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EventbriteSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "eventbrite_list",
		Description: "List records from Eventbrite. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "eventbrite_load",
		Description: "Load a single record from Eventbrite. " +
...
func runOp(client *sdk.EventbriteSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EventbriteSDK, name string) (sdk.EventbriteEntity, error) {
