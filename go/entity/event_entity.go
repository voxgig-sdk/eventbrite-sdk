...
func NewEventEntity(client *core.EventbriteSDK, entopts map[string]any) *EventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EventCreateData and returns an Event. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EventEntity) CreateTyped(reqdata EventCreateData, ctrl map[string]any) (Event, error) {
