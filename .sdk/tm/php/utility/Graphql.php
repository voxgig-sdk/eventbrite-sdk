...
// Eventbrite SDK utility: graphql
//
...
class EventbriteGraphql
{
    ...
    // equivalent.
    public static function body(EventbriteContext $ctx): mixed
    {
    ...
    public static function errors(EventbriteContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
