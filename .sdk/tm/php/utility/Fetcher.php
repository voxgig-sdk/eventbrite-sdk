...
// Eventbrite SDK utility: fetcher
...
class EventbriteFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EventbriteSDK/1.0)';
    ...
    public static function call(EventbriteContext $ctx, string $fullurl, array $fetchdef): array
    {
