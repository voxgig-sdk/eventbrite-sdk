...
class EventbriteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EventbriteTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EventbriteTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EventbriteTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
