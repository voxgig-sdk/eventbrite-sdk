# Eventbrite SDK primary utility test
...
from projectname_sdk import EventbriteSDK
from projectname_sdk.core.spec import EventbriteSpec
from projectname_sdk.core.result import EventbriteResult
from projectname_sdk.core.response import EventbriteResponse
from projectname_sdk.core.operation import EventbriteOperation
from projectname_sdk.core.error import EventbriteError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import EventbriteBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return EventbriteError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = EventbriteSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = EventbriteSDK.test(None, None)
        ...
        class TestInitFeature(EventbriteBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(EventbriteBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = EventbriteSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = EventbriteSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = EventbriteSDK.test(None, setup_opts)
