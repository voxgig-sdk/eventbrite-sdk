# Eventbrite SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, EventbriteError):
        errmsg = err.msg
    ...
    msg = "EventbriteSDK: " + opname + ": " + errmsg
    ...
    sdk_err = EventbriteError("", msg, ctx)
